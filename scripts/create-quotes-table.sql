...
--     quote_id, dealer_id, customer_name, customer_email, customer_phone,
--     boat_model, engine_package, hull_color, total_usd, total_brl, valid_until
-- ) VALUES (
--     'QUO-20240101-1234', 1, 'João Silva', 'joao@email.com', '+55 11 99999-9999',
--     'Drakkar 600', 'Mercury 150HP', 'Branco', 50000.00, 250000.00, '2024-02-01'
-- );
